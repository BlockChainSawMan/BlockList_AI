...
# # base = Path("/Users/kook/Desktop/Blockchainsawman_Blocklist") # 로컬 경로
# base = Path(".")  # 또는 Path(__file__).parent
...
data = torch.load(base / "data/elliptic_data_v2.pt", map_location=device, weights_only=False)
x, edge_index, y = data.x, data.edge_index, data.y
